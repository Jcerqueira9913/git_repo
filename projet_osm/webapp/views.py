...
pnt=resultado[1::3]
name=resultado[::3]
pnts=[1347, 1083, 496, 397, 368, 343, 159, 132, 109, 85, 75, 56, 48, 42, 35, 19, 15, 14, 10, 9, 4, 3]
pts=[]
for i,j in zip(pnt,pnts):
    pts+=[int(i)-j]
...
for h,k,l in zip(order,pts,name):
    dic[h] = [l,k,'not defined yet',(datetime.now())]
...
def index(request):
	return render(request, "webapp/index.html", {"data_1": data_1, "data_2": data_2, "data_3": data_3, "data_4": data_4, "data_5": data_5, "data_6": data_6, "data_7": data_7, "data_8": data_8, "data_9": data_9, "data_10": data_10, "data_11": data_11, "data_12": data_12, "data_13": data_13, "data_14": data_14, "data_15": data_15, "data_16": data_16, "data_17": data_17, "data_18": data_18, "data_19": data_19, "data_20": data_20, "data_21": data_21, "data_22": data_22, "data_23": data_23, "data_24": data_24})
